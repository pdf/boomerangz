import{_ as n,o as s,c as e,a2 as p}from"./chunks/framework.DjaPWvpk.js";const g=JSON.parse('{"title":"Paths and files","description":"","frontmatter":{},"headers":[],"relativePath":"reference/files.md","filePath":"reference/files.md","lastUpdated":1788977791000}'),i={name:"reference/files.md"};function t(l,a,o,c,r,d){return s(),e("div",null,[...a[0]||(a[0]=[p(`<h1 id="paths-and-files" tabindex="-1">Paths and files <a class="header-anchor" href="#paths-and-files" aria-label="Permalink to &quot;Paths and files&quot;">​</a></h1><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-jImeQ" id="tab-pJl5KdX" checked><label data-title="Arch Linux / derivatives" for="tab-pJl5KdX">Arch Linux / derivatives</label></div><div class="blocks"><div class="language-text vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/usr/bin/boomerangz</span></span>
